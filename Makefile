# This Makefile is for the EucaTest extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/EucaTest.pm]
#     AUTHOR => q[root <root@localdomain>]
#     BUILD_REQUIRES => {  }
#     NAME => q[EucaTest]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/EucaTest.pm]
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               EucaTest' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           Perl extension for Testing Eucalyptus on the QA infrastructure ' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl extension for Testing Eucalyptus on the QA infrastructure </ABSTRACT>' >> $(DISTNAME).ppd
